...
<section class="container">
 <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12 p-3 mb-2">
        <div class="">
    ...
    @csrf   
    <div class="col-md-12 col-sm-12 col-xs-12" id="mytable">             
...
$(document).ready(function() {
    ...
    $('#exportButton').click(function() {
        ...
        var htmlData = $('#mytable').html();
        var csrfToken = document.querySelector('input[name="_token"]').value;

        $.ajax({
            url: "{{ route('html.to.excel') }}", // The route you defined in your routes file
            method: 'POST',
            data: {
                _token: csrfToken,
                htmlData: htmlData
